# Transparent Nuance Version (TNV)
The Transparent Nuance Version (TNV) is a community-powered Bible translation project focused on preserving textual nuance and maintaining complete transparency in the translation process. The copyright owner retains final editorial authority while offering public feedback through an open development model.
...
Approved Resources List | /docs/recommended-resources.md with primary and supplementary resources
...
This value encompasses the editor's role AND the copyright structure:
| <color bkgd=cornflower>**Context**</color> | **Implementation** |
|-------------|--------------------|
...
Delegation pathway (trusted contributors, research assistants) | Decision authority distribution (emergency protocols if editor incapacitated)

Both levels must function simultaneously. Individual sustainability without succession leads to an eventual collapse when founder leaves.  Succession without individual sustainability leads to premature transition before institution is ready.
...
Stewardship ↔ Sustainability | Editorial control preserves quality; pacing preserves capacity | Too much stewardship (rigidity) can alienate community; too much sustainability (openness) can enable burnout
Openness ↔ Academic Rigor | Anyone can contribute if they do the work | Free openness attracts drive-by suggestions—template requirements filter without gatekeeping
